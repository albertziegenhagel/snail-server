...
struct instance_trace_header_view : private extract_view_base
{
    ...
    inline auto instance_id() const { return extract<std::uint32_t>(28 + trace_class_view::static_size + guid_view::static_size); }
    inline auto parent_instance_id() const { return extract<std::uint32_t>(32 + trace_class_view::static_size + guid_view::static_size); }
