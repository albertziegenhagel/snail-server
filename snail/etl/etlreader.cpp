...
constexpr inline auto guid_perf_info = snail::guid{
    0xce1dbfb4, 0x137e, 0x4da6, {0x87, 0xb0, 0x3f, 0x59, 0xaa, 0x10, 0x2c, 0xbc}
};
constexpr inline auto guid_stack_walk = snail::guid{
    0xdef2fe46, 0x7bd6, 0x4b80, {0xbd, 0x94, 0xf5, 0x7f, 0xe2, 0x0d, 0x0c, 0xe3}
};
constexpr inline auto guid_process = snail::guid{
    0x3d6fa8d0, 0xfe05, 0x11d0, {0x9d, 0xda, 0x00, 0xc0, 0x4f, 0xd7, 0xba, 0x7c}
};
constexpr inline auto guid_thread = snail::guid{
    0x3d6fa8d1, 0xfe05, 0x11d0, {0x9d, 0xda, 0x00, 0xc0, 0x4f, 0xd7, 0xba, 0x7c}
};
constexpr inline auto guid_image = snail::guid{
...
void event_callback(PEVENT_RECORD event_record)
{
    ...
    if(provider_guid == guid_process && ((event_record->EventHeader.EventDescriptor.Opcode == 1) || // Start
    ...
    if(provider_guid == guid_thread && ((event_record->EventHeader.EventDescriptor.Opcode == 1) || // Start
                                        (event_record->EventHeader.EventDescriptor.Opcode == 2) || // Stop
                                        (event_record->EventHeader.EventDescriptor.Opcode == 3) || // DCStart
                                        (event_record->EventHeader.EventDescriptor.Opcode == 4)    //|| // DCStop)
                                        ))
    ...
    if(provider_guid == guid_image && ((event_record->EventHeader.EventDescriptor.Opcode == 2) || // Unload
                                       (event_record->EventHeader.EventDescriptor.Opcode == 3) || // DCStart
