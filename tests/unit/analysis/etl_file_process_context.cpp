...
template<typename T>
void set_at(std::span<std::byte> buffer, std::size_t bytes_offset, T value)
{
...
void set_at(std::span<std::byte> buffer, std::size_t bytes_offset, std::string_view value)
{
...
void set_at(std::span<std::byte> buffer, std::size_t bytes_offset, std::u16string_view value)
{
...
void set_at(std::span<std::byte> buffer, std::size_t bytes_offset, const common::guid& value)
{
